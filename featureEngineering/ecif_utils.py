'''
This code is made up of functions from the GitHub referenced in the
published paper: https://doi.org/10.1093/bioinformatics/btaa982 from
Difacquim at UNAM - https://www.difacquim.com/. It is intended to
replicate their calculations of ECIFs to provide features for our
scoring funcitons
'''
