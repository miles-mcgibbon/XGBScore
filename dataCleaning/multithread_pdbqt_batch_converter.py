...
def batch_convert_to_pdbqt(druglike_structure_folders):
    threads = min(10, len(druglike_structure_folders))
...
def main():
    ...
    batch_convert_to_pdbqt(druglike_structure_folders)
